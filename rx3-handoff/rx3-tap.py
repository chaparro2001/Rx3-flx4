...
usage: rx3-tap.py x y [hold_seconds]   (the bridge places the tap on the firmware picture wherever the panel shows it)"""
import rx3_env
...
ev(3, 47, 0); ev(3, 57, 100); ev(3, 53, x); ev(3, 54, y); ev(0, 0, 0)
time.sleep(hold)
